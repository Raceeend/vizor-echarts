...
public partial class BarSeries : ISeries
{
    ...
    /// See also series-bar.coordinateSystemUsage .
    /// ]]>
    /// </summary>
    ...
    /// <![CDATA[
    /// Since v6.0.0   
    /// Specify how to lay out this series-bar based on the specified coordinateSystem .
    ///  
    ...
    ///   
    /// 'box' : (Not applicable in series-bar )  
    ...
    ///   For example, a grid component can be laid out in a matrix coordinate system or a calendar coordinate system , where its layout rectangle is calculated by the specified series-bar.coords in that system.
    ...
    ///  
    /// See also series-bar.coordinateSystem .
    /// ]]>
    /// </summary>
    ...
    /// <summary>
    /// <![CDATA[
    /// The bar gap of a single series, by default, a suitable spacing is calculated based on the number of series in the bar chart.
    /// When there are more series, the spacing will be appropriately reduced, can be set as a fixed value.
    ///  
    /// In a single coordinate system, this attribute is shared by multiple 'bar' series.
    /// This attribute should be set on the last 'bar' series in the coordinate system, then it will be adopted by all 'bar' series in the coordinate system.
    /// ]]>
    ...
    public NumberOrString? BarCategoryGap { get; set; } 
